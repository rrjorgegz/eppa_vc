...
class ConceptExpensesProduction(models.Model):
    ...
    salario = fields.Many2one("l10n_cu_mrp.wage_worker", string="Wage of the Worker", domain="[('product_tmpl_id', '=', product_tmpl_id),('company_id', '=', company_id)]", required=True)
    concept_expenses_id = fields.Many2one("l10n_cu_mrp.concept_expenses", domain="[('product_tmpl_id', '=', product_tmpl_id),('company_id', '=', company_id)]", required=True)
    mrp_production_id = fields.Many2one("mrp.production", string="Production Order", domain="[('bom_id', '=', mrp_bom_id),('company_id', '=', company_id)]", required=True)
    ...
    materias_p = fields.Float(string="Matter Prevails and Materials", help="Matter Prevails and Materials (MP)", related="mrp_production_id.total", digits="Concept of Expenses", default=0, store=True)
    ...
    dep_gd = fields.Float(string="Depreciation (GD)", help="Depreciation (GD)", default=0, digits="Concept of Expenses")
    arr_equi_gd = fields.Float(string="Lease of Teams (GD)", help="Lease of Teams (GD)", digits="Concept of Expenses", default=0)
    ...
    ene_ele_dv = fields.Float(
        string="Electric Power (DV)",
        digits="Concept of Expenses",
        store=True,
        compute="get_ene_ele_dv",
        help="Electric Power (DV)",
        default=0,
    )
    ...
    gastos_tc = fields.Float(
        string="Expenses Totales o Costo of Producción", digits="Concept of Expenses", store=True, compute="get_gastos_tc", help="Expenses Totales o Costo of Producción", default=0
    )
    ...
    coef_depre_ip = fields.Float(string="Coef D GI", digits="Concept of Expenses", help="Coefficient of Depreciation of Expenses Indirectos", default=0)
    coef_mant_rep_ip = fields.Float(string="Coef M&R GI", digits="Concept of Expenses", help="Coefficient of Maintinance and Repair of Expenses Indirectos", default=0)
    coef_otros_ip = fields.Float(string="Coef O GI ", digits="Concept of Expenses", help="Coefficient of Others of Expenses Indirectos", default=0)
    ...
    coef_alimentos_ga = fields.Float(string="Coef A GA", digits="Concept of Expenses", help="Coefficient of Foods of General Expenses and of Administration", default=0)
