...
class WageWorker(models.Model):
    ...
    date = fields.Date(string="Scheduled Date", default=datetime.today(), required=True)
    company_id = fields.Many2one("res.company", string="Companies", required=True, default=lambda self: self.env.company)
    ...
    total_salario = fields.Float("Total", default=0, digits="Price of the product", help="Total", compute="_compute_total_salario")
    ...
    salario_basico = fields.Float("Basic wage", default=0, digits="Index of Consumption", help="Basic wage = Total / a1 * a2", compute="_compute_salario_basico")
