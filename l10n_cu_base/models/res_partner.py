...
class PartnerMunicipality(models.Model):
    ...
    municipality = fields.Many2one("l10n_cu_base.res_municipality", "Municipality", help="You can associate the municipality")
    rating_id = fields.Many2one("res.partner.rating", "Partner Rating", help="You can define a rating for legal persons")
    ...
    code_one_full = fields.Char(string="Full ONE Code", help="Full Registration in National Estadistic Office.", compute="_compute_code_one_full", store=True)
...
class PartnerRating(models.Model):
    ...
    active = fields.Boolean(default=True, help="The active field allows you to hide the rating without removing it.")
