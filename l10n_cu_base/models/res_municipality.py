...
class ResCountryMunicipality(models.Model):
    ...
    code = fields.Char("Code", size=3, help="The code of the municipality have three characters", required=True)
    ...
    _sql_constraints = [("name_code_uniq", "unique(state_id, code)", "The code of the municipality should be only!")]
